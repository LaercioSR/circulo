...
Route::get('/mentoring/1', 'App\Http\Controllers\MentoringController@index')->name('mentoring.index');
...
Route::get('/profile/info', 'App\Http\Controllers\StudentController@edit')->name('student.info');
